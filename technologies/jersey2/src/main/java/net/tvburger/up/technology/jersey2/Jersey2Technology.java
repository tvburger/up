...
public final class Jersey2Technology implements UpEndpointTechnology<Jsr370.Endpoint.Info> {
    ...
    Jersey2Technology(Jersey2TechnologyManager technologyManager) {
    ...
    @Override
    public Map<UpApplication.Info, Set<Jsr370.Endpoint.Info>> listEndpoints(UpEnvironment.Info environmentInfo) {
